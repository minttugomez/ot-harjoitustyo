...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_rahaa_on_juuri_sen_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_rahaa_on_juuri_sen_verran(self):
